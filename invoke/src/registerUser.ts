...
async function main() {
    try {
        ...
        const caURL = ccp.certificateAuthorities['ca.nec.example.com'].url;
       ...
       const adminUser = await provider.getUserContext(adminIdentity, 'admin');
        ...
        const secret = await ca.register({ affiliation: 'nec.department1', enrollmentID: 'appUser', role: 'client' }, adminUser);
